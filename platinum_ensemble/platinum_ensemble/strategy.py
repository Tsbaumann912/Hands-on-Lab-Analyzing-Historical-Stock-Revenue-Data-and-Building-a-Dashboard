"""PlatinumEnsembleStrategy — combines sleeves A–E into one Signal stream."""
...
from platinum_ensemble.blend import SLEEVE_ORDER, blend_forecasts
...
class PlatinumEnsembleStrategy:
    """
    Standalone PL ensemble.
