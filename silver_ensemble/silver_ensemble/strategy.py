"""SilverEnsembleStrategy — combines sleeves A–E into one Signal stream."""
...
from silver_ensemble.blend import SLEEVE_ORDER, blend_forecasts
from silver_ensemble.data import build_feature_matrix
from silver_ensemble.forecasts import compute_all_forecasts
...
class SilverEnsembleStrategy:
    """
    Standalone SI ensemble.
